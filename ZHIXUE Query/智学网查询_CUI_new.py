#Author:Origami404
#Github:https://github.com/Origami404/CommandZhixue
from getpass import getpass
import os
import platform
from zhixuewang import Zhixuewang
#from zhixuewang import UserOrPassError
def clear_screen(): 
...
while zxw == None:
    ...
    print("Please attend that the password will not be displayed when the password is entered!")
